...
namespace Minimarket
{
    public partial class Frm_Clientes : Form
    {
        ...
        private void Formato_cl()
        {
            ...
            dataGridViewListado.Columns[0].HeaderText = "CODIGO_cl";
        ...
        private void Listado_cl(string cTexto)
        {
            try
            {
                dataGridViewListado.DataSource = N_Clientes.Listado_cl(cTexto);
                this.Formato_cl();
            }
            catch (Exception ex)
            {
        ...
        private void Listado_pc()
        {
            try
            {
                dataGridViewTD.DataSource = N_Clientes.Listado_pc();
                this.Formato_pc();
            }
            catch (Exception ex)
            {
        ...
        private void Listado_sx()
        {
            try
            {
                dataGridViewSX.DataSource = N_Clientes.Listado_sx();
                this.Formato_sx();
            }
            catch (Exception ex)
            {
        ...
        private void Listado_rb(string cTexto)
        {
            try
            {
                data_rubro.DataSource = N_Clientes.Listado_rb_cl(cTexto);
                this.Formato_rb();
            }
            catch (Exception ex)
            {
        ...
        private void Listado_c(string cTexto)
        {
            try
            {
                dataGridView_C.DataSource = N_Clientes.Listado_dis_cl(cTexto);
                this.Formato_c();
            }
            catch (Exception ex)
            {
        ...
        private void btn_guardar_Click(object sender, EventArgs e)
        {
          if (txt_TipoD.Text == String.Empty ||
            ...
            else // Registrar informacion
            {
                ...
                eCl.codigo_cl = this.codigo_cl;
                eCl.codigo_pc = this.codigo_pc;
                eCl.nrodocumento_cl = txt_NumeroD.Text.Trim();
                eCl.razon_social_cl = txt_RazonS.Text.Trim();
             
                eCl.nombres = txt_Nombres.Text.Trim();
                eCl.apellidos = txt_Apellidos.Text.Trim();
                eCl.codigo_sx = this.codigo_sx;
                eCl.codigo_rb = this.codigo_rb;
                eCl.email_cl = txt_correo.Text.Trim();
                eCl.telefono_cl = txt_telefono.Text.Trim();
                eCl.movil_cl = txt_cel.Text.Trim();
                eCl.direccion_cl = txt_Direccion.Text.Trim();
                eCl.codigo_dis = this.codigo_dis;
                eCl.observacion_cl = txt_Comentario.Text.Trim();


                respuesta = N_Clientes.Guardar_cl(EstadoGuarda, eCl);
        ...
        {
            if (string.IsNullOrEmpty(Convert.ToString(dataGridViewListado.CurrentRow.Cells["codigo_cl"].Value)))
            {
            ...
            else
            {
                ...
                txt_NumeroD.Text = Convert.ToString(dataGridViewListado.CurrentRow.Cells["nrodocumento_cl"].Value);
                txt_RazonS.Text = Convert.ToString(dataGridViewListado.CurrentRow.Cells["razon_social_cl"].Value);
                ...
                txt_correo.Text = Convert.ToString(dataGridViewListado.CurrentRow.Cells["email_cl"].Value);
                txt_telefono.Text = Convert.ToString(dataGridViewListado.CurrentRow.Cells["telefono_cl"].Value);
                txt_cel.Text = Convert.ToString(dataGridViewListado.CurrentRow.Cells["movil_cl"].Value);
                //
                ...
                //
                txt_Direccion.Text = Convert.ToString(dataGridViewListado.CurrentRow.Cells["direccion_cl"].Value);
                ...
                txt_Comentario.Text = Convert.ToString(dataGridViewListado.CurrentRow.Cells["observacion_cl"].Value).Trim();
        ...
        private void btn_eliminar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (Opcion == DialogResult.Yes)
                {
                    string respuesta = "";
                    this.codigo_cl = Convert.ToInt32(dataGridViewListado.CurrentRow.Cells["codigo_cl"].Value);
                    respuesta = N_Clientes.Eliminar_pv(this.codigo_cl);
        ...
        {
             Reportes.Frm_Reportes_Clientes oReporte_cl = new Reportes.Frm_Reportes_Clientes();
             oReporte_cl.txt_Reportes.Text = dataGridViewListado.Text;
              oReporte_cl.ShowDialog();
        ...
        {
            this.Listado_cl(dataGridViewListado.Text.Trim());
        }
