...
namespace Minimarket
{
    public partial class Frm_Almacen : Form
    {
        ...
        private void Formato_al()
        {
            ...
            dataGridViewListado.Columns[0].HeaderText = "CODIGO_AL";
            dataGridViewListado.Columns[1].Width = 300;
            dataGridViewListado.Columns[1].HeaderText = "ALMACEN";
        }
        private void Listado_al(string cTexto)
        {
            try
            {
                dataGridViewListado.DataSource = N_Almacen.Listado_al(cTexto);
                this.Formato_al();
            }
            catch (Exception ex)
            {
        ...
        {
            if (txt_almacen.Text == String.Empty)
            {
            ...
            else // Registrar informacion
            {
                ...
                oAl.descripcion_al = txt_almacen.Text.Trim();
                respuesta = N_Almacen.Guardar_al(EstadoGuarda, oAl);
                if (respuesta == "OK")
                {
                    this.Listado_al("%");
        ...
        {
            if (string.IsNullOrEmpty(Convert.ToString(dataGridViewListado.CurrentRow.Cells["codigo_al"].Value)))
            {
            ...
            else
            {
                ...
                txt_almacen.Text =Convert.ToString(dataGridViewListado.CurrentRow.Cells["descripcion_al"].Value);
            }
        }
        ...
        private void btn_eliminar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (Opcion == DialogResult.Yes)
                {
                    string  respuesta="";
                    this.codigo_al = Convert.ToInt32(dataGridViewListado.CurrentRow.Cells["codigo_al"].Value);
                    respuesta = N_Almacen.Eliminar_al(this.codigo_al);
        ...
        {
            this.Listado_al(dataGridViewListado.Text.Trim());
        }
